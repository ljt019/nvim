		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fe", function()
				telescope.extensions.file_browser.file_browser({
					...
					grouped = true, -- dirs first
					previewer = false,
					initial_mode = "normal",
				})
			end, { desc = "[F]ile [E]xplorer (Telescope)" })
		end,
	},
...
-- ty (Astral's type checker) - Neovim 0.11+ native LSP
-- Install via: uv tool install ty
vim.lsp.config("ty", {
	cmd = { "ty", "server" },
	filetypes = { "python" },
...
-- Auto-open Telescope File Browser when Neovim is opened without arguments
vim.api.nvim_create_autocmd("VimEnter", {
	callback = function()
		-- Only trigger if no file arguments were passed
